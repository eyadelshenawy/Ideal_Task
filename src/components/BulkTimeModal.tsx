...
export default function BulkTimeModal({ tasks, team, isSuperAdmin, currentUserId, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-stretch sm:items-center justify-center p-0 sm:p-4" style={{ background: "rgba(20,30,26,0.45)" }}>
      <div className="bg-white rounded-none sm:rounded-2xl w-full max-w-none sm:max-w-[720px] h-full sm:h-auto max-h-none sm:max-h-[90vh] overflow-y-auto p-4 sm:p-5">
